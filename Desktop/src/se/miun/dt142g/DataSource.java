...
public abstract class DataSource {
    ...
    /**
     * <warning>JSONException has to be cauth when this function is
     * called</warning>
    ...
    /**
     * This function is requered for all that extends this class It will
     * update/sync to the server the current information of the object
     *
     * @throws se.miun.dt142g.DataSource.WrongKeyException if no connection
     * available
     */
    ...
    /**
     * This exception class describes if there was no key match on the server or
     * we can't connect at all. Then we need to change the key and try again
     * until it works
     */
